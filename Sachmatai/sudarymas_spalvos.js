function figuros_baltos ( baltieji ) {
	...
	for ( i = 0; i < baltieji.length; i++ ) {
		...
		vieta.setAttribute("onmouseout", "normalImg(this,'"+figuros_reiksme+"',1,'"+figuros_koordinate+"')"); 
...
function figuros_juodos ( juodieji ) {
	...
	for ( i = 0; i < juodieji.length; i++ ) {
		...
		vieta.setAttribute("onmouseout", "normalImg(this,'"+figuros_reiksme+"',0,'"+figuros_koordinate+"')"); 
